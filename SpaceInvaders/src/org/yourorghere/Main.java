...
public class Main implements GLEventListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static void main(String[] args) {
        Frame frame = new Frame("Space invaders : Movement WASD");
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        // set up ligthting
        float ligth_ambient[] = {0f, 0f, 0f, 0f};
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        //Draw Halcon milenario 
        HalconMilenario halconMilenario = new HalconMilenario();
